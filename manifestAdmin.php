	...
	<div class="card" style="border: 2px solid grey;margin-bottom: 10%;margin-top: 5%; box-shadow: 0px 0px 10px 0px;" id="cardstyle">
		<div class="card-body">
			...
			<div class="form-control" role="form">
				...
				<center><button type="button" class="btn btn-success btn-lg" id="clickbk" align="center" style="margin: 10px auto;"><a href="sidebar.php" style="text-decoration: none;color: white;"><b>Exit</b></a></button></center>
			</div>
